...
public class LearningController {
    ...
    @PostMapping("/materials/{id}/reactions")
    @ResponseStatus(HttpStatus.CREATED)
    public MaterialReactionResponse toggleMaterialReaction(
            @PathVariable Long id,
            @Valid @RequestBody MaterialReactionRequest request
    ) {
        return priorityApiService.toggleMaterialReaction(id, request);
    }
}
