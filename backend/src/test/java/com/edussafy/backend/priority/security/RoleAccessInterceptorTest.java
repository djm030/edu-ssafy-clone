...
class RoleAccessInterceptorTest {
    ...
    @Test
    void publicApiDocsEndpointSkipsSessionLookup() throws Exception {
        MockHttpServletRequest request = request("GET", "/api/docs", null);
        MockHttpServletResponse response = new MockHttpServletResponse();
    ...
    private static Stream<Arguments> protectedRoleMatrix() {
        return Stream.of(
                ...
                Arguments.of("GET", "/api/attendance/appeals/pending", "learner", false),
                Arguments.of("GET", "/api/attendance/appeals/pending", "coach", true),
                Arguments.of("GET", "/api/attendance/appeals/pending", "admin", true),
