...
const targets: VisualTarget[] = [
  ...
  { name: 'live-sessions', path: '/learning/live', text: /라이브 바로가기|현재 라이브/ },
  { name: 'curriculum', path: '/learning/curriculum', text: /커리큘럼/ },
  { name: 'required-studies', path: '/learning/required-studies', text: /필수학습/ },
  { name: 'my-replays', path: '/learning/replays/my', text: /내강의 다시보기/ },
  { name: 'all-replays', path: '/learning/replays/all', text: /전체강의 다시보기/ },
