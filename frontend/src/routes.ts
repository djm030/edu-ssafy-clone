...
export const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/learning/replays/my', label: '내강의 다시보기' },
      { path: '/learning/replays/all', label: '전체강의 다시보기' },
...

  {
    ...
    items: [
      ...
      { path: '/mentoring/notices', label: '멘토링 공지사항' },
      { path: '/mentoring/meetings', label: '간담회 신청' },
      { path: '/mentoring/meeting-results', label: '간담회 정보' },
      { path: '/mentoring/meeting-reviews', label: '간담회 후기' },
    ],
  },
  {
    title: '도움말',
...
export const screenSmokeRoutes: ScreenSmokeRoute[] = [
  ...
  { id: 'mentoring-notices', priority: 23, feature: '멘토링 공지사항', path: '/mentoring/notices', label: '멘토링 공지 목록' },
  { id: 'mentoring-notice-detail', priority: 23, feature: '멘토링 공지사항', path: '/mentoring/notices/1', label: '멘토링 공지 상세' },
  { id: 'mentoring-meetings', priority: 24, feature: '간담회 신청', path: '/mentoring/meetings', label: '간담회 목록' },
  { id: 'mentoring-meeting-detail', priority: 24, feature: '간담회 신청', path: '/mentoring/meetings/1', label: '간담회 상세' },
  { id: 'mentoring-meeting-applications', priority: 24, feature: '간담회 신청', path: '/mentoring/meetings/my-applications', label: '내 간담회 신청' },
  { id: 'mentoring-meeting-results', priority: 25, feature: '간담회 정보', path: '/mentoring/meeting-results', label: '간담회 정보 목록' },
  { id: 'mentoring-meeting-result-detail', priority: 25, feature: '간담회 정보', path: '/mentoring/meeting-results/993', label: '간담회 정보 상세' },
  { id: 'mentoring-meeting-reviews', priority: 25, feature: '간담회 후기', path: '/mentoring/meeting-reviews', label: '간담회 후기 목록' },
  { id: 'mentoring-meeting-review-write', priority: 25, feature: '간담회 후기', path: '/mentoring/meeting-reviews/write', label: '간담회 후기 작성' },
  { id: 'mentoring-meeting-review-detail', priority: 25, feature: '간담회 후기', path: '/mentoring/meeting-reviews/1301', label: '간담회 후기 상세' },
  ...
  { id: 'my-replays', priority: 18, feature: '내강의 다시보기', path: '/learning/replays/my', label: '내강의 다시보기' },
  { id: 'all-replays', priority: 18, feature: '전체강의 다시보기', path: '/learning/replays/all', label: '전체강의 다시보기' },
