...
export const mockPosts: BoardPostListItem[] = [
  { id: 101, boardCode: 'notice', category: { id: 1, name: '전체 공지' }, title: '4월 공통 프로젝트 일정 안내', authorName: '교육지원팀', createdAt: '2026-04-24T09:00:00+09:00', viewCount: 145, commentCount: 0, reactionCount: 0, bookmarkCount: 8, hasAttachment: true, isPinned: true, content: '4월 공통 프로젝트 일정과 제출 마감 시간이 확정되었습니다. 팀별 진행 상황을 확인하고 지정된 시간 안에 산출물을 제출해 주세요.' },
  ...
  { id: 203, boardCode: 'free', category: { id: 6, name: '스터디' }, title: '관통 프로젝트 회고 템플릿 공유', authorName: '최싸피', createdAt: '2026-04-23T18:21:00+09:00', viewCount: 64, commentCount: 3, reactionCount: 15, bookmarkCount: 9, hasAttachment: true, content: '팀 회고에 사용할 수 있는 간단한 템플릿을 공유합니다.' },
...
export const mockMaterials: LearningMaterial[] = [
  { id: 1, title: 'Spring Boot REST API 실습 자료', type: 'file', authorName: '교수지원', createdAt: '2026-04-24', viewCount: 184, likeCount: 12, bookmarkCount: 5, favoriteCount: 3, fileName: 'spring-rest-api.pdf', description: 'REST API 계층 설계와 예외 처리 실습 자료입니다.' },
  { id: 2, title: 'JPA 기본 개념 eBook', type: 'ebook', authorName: '교육지원팀', createdAt: '2026-04-23', viewCount: 231, likeCount: 18, bookmarkCount: 7, favoriteCount: 4, fileName: 'jpa-basics.epub', description: '엔티티, 연관관계, 영속성 컨텍스트를 정리한 eBook입니다.' },
  { id: 3, title: 'Vue 상태 관리 다시보기', type: 'video', authorName: '강의실', createdAt: '2026-04-22', viewCount: 97, likeCount: 9, bookmarkCount: 2, favoriteCount: 1, description: 'Vue 상태 관리 강의 다시보기 링크입니다.' },
  { id: 4, title: 'Git 협업 체크리스트', type: 'link', authorName: '운영자', createdAt: '2026-04-21', viewCount: 143, likeCount: 6, bookmarkCount: 8, favoriteCount: 2, description: '팀 협업 전 확인해야 할 Git 규칙 체크리스트입니다.' },
];
