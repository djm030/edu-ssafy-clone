...
export const mockLevelDetail: LevelDetailResponse = {
  detail: {
    ...
    expRemaining: 800,
    tiers: [
      { name: 'Bronze', minLevel: 1, maxLevel: 4, current: false, progressPercent: 100, visualState: 'completed', scholarshipLabel: '달성 완료', description: '기초 학습과 출석 루틴을 쌓는 단계' },
      { name: 'Silver', minLevel: 5, maxLevel: 8, current: true, progressPercent: 25, visualState: 'active', scholarshipLabel: '현재 단계', description: '프로젝트 실습과 Quest 수행이 누적되는 단계' },
      { name: 'Gold', minLevel: 9, maxLevel: 12, current: false, progressPercent: 0, visualState: 'locked', scholarshipLabel: '미달성', description: '심화 학습과 팀 기여도가 반영되는 단계' },
      { name: 'Platinum', minLevel: 13, maxLevel: 16, current: false, progressPercent: 0, visualState: 'locked', scholarshipLabel: '미달성', description: '우수 학습자 랭킹과 장학 포인트 경쟁 단계' },
    ],
    history: [
...
export const mockPosts: BoardPostListItem[] = [
  ...
  { id: 204, boardCode: 'anonymous', category: { id: 11, name: '익명' }, title: '익명으로 학습 고민을 공유합니다', authorName: '익명', createdAt: '2026-04-24T19:00:00+09:00', viewCount: 27, commentCount: 2, reactionCount: 5, bookmarkCount: 1, content: '강의 진도를 따라가는 방법을 익명으로 묻고 싶습니다.', comments: [{ id: 2041, postId: 204, content: '스터디 시간을 짧게 고정해 보세요.', authorName: '익명', createdAt: '2026-04-24T20:00:00+09:00', replies: [] }], safety: { status: 'normal', label: '익명 보호', reportCount: 0, reportable: true, notice: '작성자 정보는 익명으로 보호되며 신고가 누적되면 자동 블라인드됩니다.' } },
