...
| OMX team completion | FAIL | worker-1 recheck summary reported total=136, completed=68, pending=66, in_progress=2, failed=0; workers were not alive. |
...
4. OMX team state는 아직 완료가 아니다: worker-1 recheck 기준 total=136, completed=68, pending=66, in_progress=2, failed=0, workers not alive.
