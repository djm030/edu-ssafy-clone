-- SSAFY clone coding normalized schema
-- Purpose: ERDCloud import / initial implementation-oriented relational model
...
DROP TABLE IF EXISTS `support_ticket_answers`;
